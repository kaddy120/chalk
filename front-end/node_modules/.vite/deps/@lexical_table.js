...
var require_LexicalTable_dev = __commonJS({
  "../node_modules/@lexical/table/LexicalTable.dev.js"(exports) {
    ...
    var TableCellNode = class _TableCellNode extends lexical.DEPRECATED_GridCellNode {
      /** @internal */
      /** @internal */
      /** @internal */
      static getType() {
      ...
      static clone(node) {
        const cellNode = new _TableCellNode(node.__headerState, node.__colSpan, node.__width, node.__key);
      ...
      static importJSON(serializedNode) {
        ...
        const cellNode = $createTableCellNode(serializedNode.headerState, colSpan, serializedNode.width || void 0);
    ...
    var TableRowNode = class _TableRowNode extends lexical.DEPRECATED_GridRowNode {
      /** @internal */
      static getType() {
        return "tablerow";
      }
    ...
    var TableSelection = class {
      ...
      formatCells(type) {
        this.editor.update(() => {
          ...
          this.editor.dispatchCommand(lexical.SELECTION_CHANGE_COMMAND, void 0);
        });
      }
      clearText() {
        const editor = this.editor;
    ...
    var TableNode = class _TableNode extends lexical.DEPRECATED_GridNode {
      /** @internal */
      static getType() {
        return "table";
      }
...
export default require_LexicalTable();
//# sourceMappingURL=@lexical_table.js.map
